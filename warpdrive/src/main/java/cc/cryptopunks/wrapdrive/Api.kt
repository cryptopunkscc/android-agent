...
interface WarpdriveClient {
    ...
    suspend fun listOffers(filter: Filter = FilterAll): List<Offer>
    fun listenOffers(filter: Filter = FilterAll): Flow<Offer>
    fun listenStatus(filter: Filter = FilterAll): Flow<Status>
    suspend fun listPeers(): List<Peer>
    suspend fun updatePeer(peer: PeerId, attr: String, value: String)
}
...
typealias Filter = Int
const val FilterAll = 0
const val FilterIn = 1
const val FilterOut = 2
