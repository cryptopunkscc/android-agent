...
import cc.cryptopunks.wrapdrive.share.startShareActivity

@Composable
internal fun NoOffersView(
    filter: Filter,
) {
    when (filter) {
...
@Preview
@Composable
private fun NoReceivedOffersPreview() = PreviewBox {
    NoReceivedOffers()
}

@Composable
private fun NoReceivedOffers() {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(48.dp),
...
@Preview
@Composable
private fun NoSentOffersPreview() = PreviewBox {
    NoSentOffers()
}

@Composable
private fun NoSentOffers() {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(48.dp),
